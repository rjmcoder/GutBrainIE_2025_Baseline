...
if __name__ == '__main__':
    ...
    if eval_6_1_NER:
        ...
        print("\n\n=== 6_1_NER ===")
        print(f"precision: {round(precision, round_to_decimal_position)}")
        print(f"recall: {round(recall, round_to_decimal_position)}")
        print(f"F1: {round(f1, round_to_decimal_position)}")
